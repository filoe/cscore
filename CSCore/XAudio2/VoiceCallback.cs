...
namespace CSCore.XAudio2
{
    ...
    public class VoiceCallback : IXAudio2VoiceCallback
    {
        ...
        /// The only argument passed to the eventhandler is a context pointer that was assigned to the pContext member of the <see cref="XAudio2Buffer"/> structure when the buffer was submitted.
        /// </summary>
        ...
        /// The first argument passed to the eventhandler is a context pointer that was assigned to the pContext member of the <see cref="XAudio2Buffer"/> structure when the buffer was submitted.

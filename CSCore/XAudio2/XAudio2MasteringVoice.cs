...
namespace CSCore.XAudio2
{
    ...
    public class XAudio2MasteringVoice : XAudio2Voice
    {
        ...
        /// </summary>
        /// <param name="channelMask">Returns the channel mask for this voice. This corresponds to the <see cref="WaveFormatExtensible.ChannelMask"/> member of the <see cref="WaveFormatExtensible"/> class.</param>
        /// <returns>HRESULT</returns>
        public unsafe int GetChannelMaskNative(out ChannelMask channelMask)
        {
            fixed (void* p = &channelMask)
            {
                return InteropCalls.CallI(_basePtr, p, ((void**) (*(void**) _basePtr))[19]);
            }
        }
    }
}
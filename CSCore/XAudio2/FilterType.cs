namespace CSCore.XAudio2
{
    ...
    public enum FilterType
    {
        ...
        NotchFilter = 3,
        /// <summary>
        /// Attenuates frequencies above the cutoff frequency. This is a one-pole filter, and <see cref="FilterParameters.OneOverQ"/> has no effect.
        /// </summary>
        LowPassOnePoleFilter = 4,
        /// <summary>
        /// Attenuates frequencies below the cutoff frequency. This is a one-pole filter, and <see cref="FilterParameters.OneOverQ"/> has no effect.
        /// </summary>

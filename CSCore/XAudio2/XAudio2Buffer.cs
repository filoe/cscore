...
namespace CSCore.XAudio2
{
    ...
    public struct XAudio2Buffer
    {
        ...
        /// Fore more details see http://msdn.microsoft.com/en-us/library/windows/desktop/microsoft.directx_sdk.xaudio2.xaudio2_buffer(v=vs.85).aspx.
        /// </summary>
        ...
        /// <summary>
        /// First sample of the region to be looped. The value of <see cref="LoopBegin"/> must be less than <see cref="PlayBegin"/> + <see cref="PlayLength"/>.
        /// <see cref="LoopBegin"/> can be less than <see cref="PlayBegin"/>. <see cref="LoopBegin"/> must be 0 if <see cref="LoopCount"/> is 0.
        /// </summary>
        public int LoopBegin;

        /// <summary>
        /// Length of the loop region, in samples. 
        /// The value of <see cref="LoopBegin"/> + <see cref="LoopLength"/> must be greater than <see cref="PlayBegin"/> and less than <see cref="PlayBegin"/> + <see cref="PlayLength"/>. 
        ...
        /// <returns><see cref="UnmanagedMemoryStream"/></returns>

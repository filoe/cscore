...
namespace CSCore.XAudio2
{
    ...
    public class XAudio2SourceVoice : XAudio2Voice
    {
        ...
        /// <param name="operationSet">Identifies this call as part of a deferred batch. For more details see http://msdn.microsoft.com/en-us/library/windows/desktop/ee415807(v=vs.85).aspx. </param>
        /// <returns>HRESULT</returns>
        public unsafe int StartNative(int flags, int operationSet)
        {
            return InteropCalls.CallI(_basePtr, flags, operationSet, ((void**) (*(void**) _basePtr))[19]);
        }
        ...
        /// </summary>
        /// <param name="flags">Flags that control how the voice is stopped. Can be <see cref="SourceVoiceStopFlags.None"/> or <see cref="SourceVoiceStopFlags.PlayTails"/>.</param>
        /// <param name="operationSet">Identifies this call as part of a deferred batch. For more details see http://msdn.microsoft.com/en-us/library/windows/desktop/ee415807(v=vs.85).aspx. </param>
        /// <returns>HRESULT</returns>
        public unsafe int StopNative(SourceVoiceStopFlags flags, int operationSet)
        {
            return InteropCalls.CallI(_basePtr, flags, operationSet, ((void**)(*(void**)_basePtr))[20]);
        }
        ...
        /// <returns>HRESULT</returns>
        /// <remarks>See http://msdn.microsoft.com/en-us/library/windows/desktop/microsoft.directx_sdk.ixaudio2sourcevoice.ixaudio2sourcevoice.submitsourcebuffer(v=vs.85).aspx. </remarks>
        public unsafe int SubmitSourceBufferNative(IntPtr buffer, IntPtr bufferWma)
        {
            return InteropCalls.CallI(_basePtr, (void*) buffer, (void*) bufferWma, ((void**) (*(void**) _basePtr))[21]);
        }
        ...
        /// </summary>
        /// <returns>HRESULT</returns>
        /// <remarks>See http://msdn.microsoft.com/en-us/library/windows/desktop/microsoft.directx_sdk.ixaudio2sourcevoice.ixaudio2sourcevoice.flushsourcebuffers(v=vs.85).aspx. </remarks>
        public unsafe int FlushSourceBuffersNative()
        {
            return InteropCalls.CallI(_basePtr, ((void**) (*(void**) _basePtr))[22]);
        }
        ...
        {
            return InteropCalls.CallI(_basePtr, ((void**) (*(void**) _basePtr))[23]);
        }
        ...
        {
            return InteropCalls.CallI(_basePtr, operationSet, ((void**) (*(void**) _basePtr))[24]);
        }
        ...
        /// The default value is <see cref="GetVoiceStateFlags.Default"/>. If you specify <see cref="GetVoiceStateFlags.NoSamplesPlayed"/>, GetState 
        /// returns only the buffer state, not the sampler state. 
        /// GetState takes roughly one-third as much time to complete when you specify <see cref="GetVoiceStateFlags.NoSamplesPlayed"/>.
        /// </param>
        ...
        public unsafe VoiceState GetState(GetVoiceStateFlags flags)
        {
            ...
            InteropCalls.CallI1(_basePtr, &voiceState, flags, ((void**) (*(void**) _basePtr))[25]);
            return voiceState;
        }
        ...
        /// the MaxFrequencyRatio parameter specified when the voice was created <see cref="XAudio2.CreateSourceVoice(CSCore.WaveFormat,CSCore.XAudio2.VoiceFlags,float,CSCore.XAudio2.IXAudio2VoiceCallback,System.Nullable{CSCore.XAudio2.VoiceSends},System.Nullable{CSCore.XAudio2.EffectChain})"/>. 
        /// </param>
        /// <param name="operationSet">Identifies this call as part of a deferred batch. For more details see http://msdn.microsoft.com/en-us/library/windows/desktop/ee415807(v=vs.85).aspx. </param>
        /// <returns>HRESULT</returns>
        public unsafe int SetFrequencyRatioNative(float ratio, int operationSet)
        {
            return InteropCalls.CallI(_basePtr, ratio, operationSet, ((void**) (*(void**) _basePtr))[26]);
        }
        ...
        public unsafe float GetFrequencyRatio()
        {
            ...
            return InteropCalls.CallI1(_basePtr, &value, ((void**) (*(void**) _basePtr))[27]);
        }
        ...
        {
            return InteropCalls.CallI(_basePtr, newSourceSampleRate, ((void**) (*(void**) _basePtr))[28]);
        }

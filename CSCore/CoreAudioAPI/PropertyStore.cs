...
namespace CSCore.CoreAudioAPI
{
    ...
    public class PropertyStore : ComObject, IEnumerable<KeyValuePair<PropertyKey, PropertyVariant>>
    {
        ...
        public PropertyVariant GetValue(PropertyKey key)
        {
            ...
            CoreAudioAPIException.Try(result, c, "GetValue");
            return value;
        }
        ...
        public PropertyKey GetKey(int index)
        {
            ...
            CoreAudioAPIException.Try(result, c, "GetAt");
            return key;
        }
        ...
        public void SetValue(PropertyKey key, PropertyVariant value)
        {
            ...
            CoreAudioAPIException.Try(result, c, "SetValue");
        }
        ...
        {
            int count;
            CoreAudioAPIException.Try(GetCountInternal(out count), c, "GetCount");
            return count;
        }

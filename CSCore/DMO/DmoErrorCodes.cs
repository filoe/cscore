...
namespace CSCore.DMO
{
    ...
    public enum DmoErrorCodes : int
    {
        ...
        /// <summary>
        /// Data cannot be accepted on this stream. You might need to process more output data; see IMediaObject::ProcessInput (-> http://msdn.microsoft.com/en-us/library/windows/desktop/dd406959(v=vs.85).aspx).
        /// </summary>
